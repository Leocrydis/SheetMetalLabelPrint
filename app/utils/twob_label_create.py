...
def create_label(data, data_type):
    ...
    y_positions = [2, 7, 7, 12, 17, 12, 22]  # Adjust these values as needed
    ...
    x_positions_row3_4 = [0, 28]  # Column 1 starts at 0, Column 2 starts at 28 mm
    ...
    for i, text in enumerate(texts):
        ...
        if i == 0:  # Row 1
            ...
            if nomex_layers:
                l.origin(x_positions_row3_4[1] - 2, y_position + 3)
            ...
            l.origin(0, y_position)
            l.write_text(text, char_height=2.5, char_width=2.5, line_width=label_width_mm, justification='C')
            l.endorigin()
